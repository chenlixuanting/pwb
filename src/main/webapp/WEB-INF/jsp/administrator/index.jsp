...
<head>
    ...
    <!-- Twitter meta-->
    <meta property="keywords" content="个人技术博客">
    <meta property="twitter:site" content="@pratikborsadiya">
    <meta property="author" content="2583744237@qq.com">
...
<!-- Navbar-->
<header class="app-header"><a class="app-header__logo" href="index.html">Cake</a>
...
<script type="text/javascript" src="asset/administrator/js/plugins/chart.js"></script>
